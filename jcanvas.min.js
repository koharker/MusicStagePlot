...
!function(a, b, c) {
    ...
    function h(a) {
        ...
        for (b in a)
            ...
            "string" === sa(c) && f(c) && "text" !== b && (a[b] = pa(c)));
    ...
    function k(a, b) {
        0 === b.savedTransforms.length ? b.transforms = i(Fa) : (a.restore(),
    ...
    function q(a, b, c, d, e) {
        ...
        c._centered = !0),
        c.rotate && R(b, c, null),
        1 === c.scale && 1 === c.scaleX && 1 === c.scaleY || S(b, c, null),
        (c.translate || c.translateX || c.translateY) && T(b, c, null)
    }
    function r(b) {
    ...
    function s(a, b, c) {
        var d;
        for (d in Ia.events)
            Object.prototype.hasOwnProperty.call(Ia.events, d) && (c[d] || c.cursors && c.cursors[d]) && u(a, b, c, d);
    ...
    function F(a, b, c, d, e) {
        E(c, d) && ("mouseout" !== d && B(a, c, d),
        D(a, c, d, c, e),
        D(a, c, d, b.eventHooks, e),
        D(a, c, d, Ia.eventHooks, e))
    }
    function G(b, d, f, g) {
        ...
        d.layer && !d._layer ? (i = a(b),
        j = r(b),
        k = j.layers,
        (null === l.name || e(l.name) && void 0 === j.layer.names[l.name]) && (h(d),
        l = new c(d),
        l.canvas = b,
        l.layer = !0,
        l._layer = !0,
        l._running = {},
        null !== l.data ? l.data = qa({}, l.data) : l.data = {},
    ...
    function J(a, b, c) {
        ...
        for (d in c)
            ...
            ta(e) && (c[d] = e.call(a, b, d)),
            "object" === sa(e) && ua(e))) {
                for (f in e)
                    Object.prototype.hasOwnProperty.call(e, f) && (g = e[f],
                    void 0 !== b[d] && (b[d + "." + f] = b[d][f],
                    c[d + "." + f] = g));
                delete c[d]
            }
        return c
    ...
    function L(b) {
        var c, d, e = [], f = 1;
        return "transparent" === b ? b = "rgba(0, 0, 0, 0)" : b.match(/^([a-z]+|#[0-9a-f]+)$/gi) && (d = ja.head,
        c = d.style.color,
        d.style.color = b,
        b = a.css(d, "color"),
        d.style.color = c),
        ...
        e[1] *= f,
        e[2] *= f,
        void 0 !== e[3] ? e[3] = pa(e[3]) : e[3] = 1),
        e
    }
    function M(a) {
        var b, c = 3;
        for ("array" !== sa(a.start) && (a.start = L(a.start),
        a.end = L(a.end)),
        a.now = [],
    ...
    function Z(a, b, c, d, e, f, g, h) {
        ...
        d.startArrow && Y(a, b, c, d, e, f, g, h)
    }
    function $(a, b, c, d, e, f, g, h) {
        d._arrowAngleConverted || (d.arrowAngle *= c._toRad,
        d._arrowAngleConverted = !0),
        d.endArrow && Y(a, b, c, d, e, f, g, h)
    }
    function _(a, b, c, d) {
        var e, f, g;
        for (e = 2,
        Z(a, b, c, d, d.x2 + c.x, d.y2 + c.y, d.x1 + c.x, d.y1 + c.y),
        ...
        e -= 1,
        $(a, b, c, d, d["x" + (e - 1)] + c.x, d["y" + (e - 1)] + c.y, d["x" + e] + c.x, d["y" + e] + c.y)
    }
    function aa(a, b, c, d) {
        var e, f, g, h, i;
        for (e = 2,
        Z(a, b, c, d, d.cx1 + c.x, d.cy1 + c.y, d.x1 + c.x, d.y1 + c.y),
        void 0 !== d.x1 && void 0 !== d.y1 && b.moveTo(d.x1 + c.x, d.y1 + c.y); ; ) {
            if (f = d["x" + e],
            g = d["y" + e],
            h = d["cx" + (e - 1)],
        ...
        e -= 1,
        $(a, b, c, d, d["cx" + (e - 1)] + c.x, d["cy" + (e - 1)] + c.y, d["x" + e] + c.x, d["y" + e] + c.y)
    }
    function ba(a, b, c, d) {
        var e, f, g, h, i, j, k, l;
        for (e = 2,
        ...
        e -= 1,
        f -= 2,
        $(a, b, c, d, d["cx" + (f + 1)] + c.x, d["cy" + (f + 1)] + c.y, d["x" + e] + c.x, d["y" + e] + c.y)
    }
    function ca(a, b, c) {
        return b *= a._toRad,
        b -= va / 2,
    ...
    function ea(a, b, c, d) {
        ...
        j = l = n = d.x + h,
        k = m = o = d.y + i,
        Z(a, b, c, d, j + ca(c, d.a1, d.l1), k + da(c, d.a1, d.l1), j, k),
    ...
    function fa(a, b, c) {
        isNaN(oa(c.fontSize)) || (c.fontSize += "px"),
    ...
    function ga(b, c, d, e) {
        ...
        if (i.text === d.text && i.fontStyle === d.fontStyle && i.fontSize === d.fontSize && i.fontFamily === d.fontFamily && i.maxWidth === d.maxWidth && i.lineHeight === d.lineHeight)
            ...
            d.height = pa(a.css(b, "fontSize")) * e.length * d.lineHeight,
            b.style.fontSize = f
        }
    }
    function ha(a, b) {
    ...
    var ia, ja = b.document, ka = b.Image, la = b.Array, ma = b.getComputedStyle, na = b.Math, oa = b.Number, pa = b.parseFloat, qa = a.extend, ra = a.inArray, sa = function(a) {
        return Object.prototype.toString.call(a).slice(8, -1).toLowerCase()
    }, ta = a.isFunction, ua = a.isPlainObject, va = na.PI, wa = na.round, xa = na.abs, ya = na.sin, za = na.cos, Aa = na.atan2, Ba = la.prototype.slice, Ca = a.event.fix, Da = {}, Ea = {
        dataCache: {},
        propCache: {},
        imageCache: {}
    }, Fa = {
    ...
    Ia.extend = function(b) {
        return b.name && (b.props && qa(ia, b.props),
        ...
        for (e = 0; e < m.length; e += 1)
            ...
            i = a(m[e]).getLayer(b)) {
                ...
                for (j in c)
                    ...
                    l = sa(k),
                    "object" === l && ua(k) ? (i[j] = qa({}, k),
                    h(i[j])) : "array" === l ? i[j] = k.slice(0) : "string" === l ? 0 === k.indexOf("+=") ? i[j] += pa(k.substr(2)) : 0 === k.indexOf("-=") ? i[j] -= pa(k.substr(2)) : !isNaN(k) && f(k) && "text" !== j ? i[j] = pa(k) : i[j] = k : i[j] = k);
                s(d, g, i),
                v(d, g, i),
                !1 === a.isEmptyObject(c) && F(d, g, i, "change", c)
            }
        return m
    }
    ,
    ...
    a.fn.removeLayerFromGroup = function(b, c) {
        ...
        for (e = 0; e < h.length; e += 1)
            d = a(h[e]),
            f = d.getLayer(b),
            f.groups && -1 !== (g = ra(c, f.groups)) && (i = f.groups.slice(0),
            i.splice(g, 1),
            d.setLayer(f, {
                groups: i
            }));
    ...
    a.fn.drawLayer = function(b) {
        ...
        for (c = 0; c < h.length; c += 1)
            e = a(h[c]),
            (d = g(h[c])) && (f = e.getLayer(b),
            z(e, d, f));
        return h
    }
    ,
    a.fn.drawLayers = function(b) {
        var c, d, e, f, h, j, k, l, m, n, o, p, q, s = this, t = b || {};
        for (l = t.index,
        l || (l = 0),
        d = 0; d < s.length; d += 1)
            if (c = a(s[d]),
            e = g(s[d])) {
                ...
                k = l; k < f.length; k += 1)
                    if (h = f[k],
                    h.index = k,
                    t.resetFire && (h._fired = !1),
                    z(c, e, h, k + 1),
                    h._masks = n.transforms.masks.slice(0),
                    h._method === a.fn.drawImage && h.visible) {
                        q = !0;
                        break
                    }
                if (q)
                ...
                o = n.event,
                p = o.type,
                n.drag.layer && A(c, n, p),
                j = n.lastIntersected,
                null === j || h === j || !j._hovered || j._fired || n.drag.dragging || (n.lastIntersected = null,
                j._fired = !0,
                j._hovered = !1,
                F(c, n, j, "mouseout"),
                C(c, n)),
                h && (h[p] || (p = O(p)),
                h._event && h.intersects && (n.lastIntersected = h,
                (h.mouseover || h.mouseout || h.cursors) && !n.drag.dragging && (h._hovered || h._fired || (h._fired = !0,
                h._hovered = !0,
                F(c, n, h, "mouseover"))),
                h._fired || (h._fired = !0,
                o.type = null,
    ...
    a.fn.animateLayer = function() {
        var b, c, d, e, f, h = this, i = Ba.call(arguments, 0);
        for ("object" === sa(i[2]) ? (i.splice(2, 0, i[2].duration || null),
        i.splice(3, 0, i[3].easing || null),
        i.splice(4, 0, i[4].complete || null),
        i.splice(5, 0, i[5].step || null)) : (void 0 === i[2] ? (i.splice(2, 0, null),
        i.splice(3, 0, null),
        i.splice(4, 0, null)) : ta(i[2]) && (i.splice(2, 0, null),
        i.splice(3, 0, null)),
        void 0 === i[3] ? (i[3] = null,
        i.splice(4, 0, null)) : ta(i[3]) && i.splice(3, 0, null)),
        c = 0; c < h.length; c += 1)
            b = a(h[c]),
            g(h[c]) && (d = r(h[c]),
            (e = b.getLayer(i[0])) && e._method !== a.fn.draw && (f = qa({}, i[1]),
            f = J(h[c], e, f),
            I(f, !0),
            I(e),
            e.style = Ga.propsObj,
    ...
    a.fn.draw = function a(b) {
        var d, e, f = this, h = new c(b);
        if (Da.drawings[h.type] && "function" !== h.type)
            f[Da.drawings[h.type]](b);
        else
            for (d = 0; d < f.length; d += 1)
                (e = g(f[d])) && (h = new c(b),
                G(f[d], h, b, a),
                h.visible && h.fn && h.fn.call(f[d], e, h));
        return f
    }
    ,
    a.fn.clearCanvas = function a(b) {
        var d, e, f = this, h = new c(b);
        for (d = 0; d < f.length; d += 1)
            (e = g(f[d])) && (null === h.width || null === h.height ? (e.save(),
            e.setTransform(1, 0, 0, 1, 0, 0),
            e.clearRect(0, 0, f[d].width, f[d].height),
            e.restore()) : (G(f[d], h, b, a),
            q(f[d], e, h, h.width, h.height),
    ...
    a.fn.drawRect = function a(b) {
        ...
        for (d = 0; d < o.length; d += 1)
            (e = g(o[d])) && (f = new c(b),
            G(o[d], f, b, a),
            f.visible && (q(o[d], e, f, f.width, f.height),
            m(o[d], e, f),
            e.beginPath(),
            f.width && f.height && (h = f.x - f.width / 2,
            i = f.y - f.height / 2,
            l = xa(f.cornerRadius),
            l ? (j = f.x + f.width / 2,
            k = f.y + f.height / 2,
            ...
            e.lineTo(h + l, k),
            e.arc(h + l, k - l, l, va / 2, va, !1),
            e.lineTo(h, i + l),
            e.arc(h + l, i + l, l, va, 3 * va / 2, !1),
            f.closed = !0) : e.rect(h, i, f.width, f.height)),
            Q(o[d], e, f),
            p(o[d], e, f)));
        return o
    }
    ...
    a.fn.drawArc = function a(b) {
        ...
        for (d = 0; d < h.length; d += 1)
            (e = g(h[d])) && (f = new c(b),
            G(h[d], f, b, a),
            f.visible && (q(h[d], e, f, 2 * f.radius),
            m(h[d], e, f),
            e.beginPath(),
            X(h[d], e, f, f),
            Q(h[d], e, f),
    ...
    a.fn.drawEllipse = function a(b) {
        ...
        for (d = 0; d < j.length; d += 1)
            (e = g(j[d])) && (f = new c(b),
            G(j[d], f, b, a),
            f.visible && (q(j[d], e, f, f.width, f.height),
            m(j[d], e, f),
            h = f.width * (4 / 3),
            i = f.height,
            e.beginPath(),
    ...
    a.fn.drawPolygon = function a(b) {
        ...
        for (d = 0; d < r.length; d += 1)
            if ((e = g(r[d])) && (f = new c(b),
            G(r[d], f, b, a),
            f.visible)) {
                for (q(r[d], e, f, 2 * f.radius),
                m(r[d], e, f),
                i = 2 * va / f.sides,
                j = i / 2,
                h = j + va / 2,
                ...
                o = 0; o < f.sides; o += 1)
                    ...
                    n = f.y + f.radius * ya(h),
                    e.lineTo(l, n),
                    f.concavity && (l = f.x + (k + -k * f.concavity) * za(h + j),
                    n = f.y + (k + -k * f.concavity) * ya(h + j),
                    e.lineTo(l, n)),
                    h += i;
                Q(r[d], e, f),
                f.closed = !0,
    ...
    a.fn.drawSlice = function a(b) {
        ...
        for (d = 0; d < k.length; d += 1)
            (e = g(k[d])) && (f = new c(b),
            G(k[d], f, b, a),
            f.visible && (q(k[d], e, f, 2 * f.radius),
            m(k[d], e, f),
            f.start *= f._toRad,
            f.end *= f._toRad,
            f.start -= va / 2,
            ...
            h = (f.start + f.end) / 2,
            i = f.radius * f.spread * za(h),
            j = f.radius * f.spread * ya(h),
            f.x += i,
            f.y += j,
            e.beginPath(),
            ...
            f.visible)) {
                ...
                h = 1; ; ) {
                    if (void 0 === (i = f["p" + h]))
                        break;
                    i = new c(i),
                    "line" === i.type ? _(j[d], e, f, i) : "quadratic" === i.type ? aa(j[d], e, f, i) : "bezier" === i.type ? ba(j[d], e, f, i) : "vector" === i.type ? ea(j[d], e, f, i) : "arc" === i.type && X(j[d], e, f, i),
                    h += 1
                }
                Q(j[d], e, f),
                p(j[d], e, f)
    ...
    a.fn.drawText = function a(b) {
        ...
        for (d = 0; d < v.length; d += 1)
            if ((e = g(v[d])) && (f = new c(b),
            G(v[d], f, b, a),
            f.visible)) {
                if (e.textBaseline = f.baseline,
                e.textAlign = f.align,
                fa(v[d], e, f),
                i = null !== f.maxWidth ? ha(e, f) : f.text.toString().split("\n"),
                ga(v[d], e, f, i),
                h && (h.width = f.width,
                h.height = f.height),
                ...
                f.radius)
                    ...
                    k = 0; k < i.length; k += 1) {
                        ...
                        e.translate(f.x, f.y),
                        j = i[k],
                        f.flipArcText && (p = j.split(""),
                        p.reverse(),
                        j = p.join("")),
                        n = j.length,
                        e.rotate(-va * f.letterSpacing * (n - 1) / 2),
                        s = 0; s < n; s += 1)
                            r = j[s],
    ...
    a.fn.drawImage = function b(d) {
        function e(a, b, c, d, e) {
            ...
            m(a, b, d),
            b.drawImage(s, d.sx - d.sWidth / 2, d.sy - d.sHeight / 2, d.sWidth, d.sHeight, d.x - d.width / 2, d.y - d.height / 2, d.width, d.height)) : (q(a, b, d, d.width, d.height),
            m(a, b, d),
            b.drawImage(s, d.x - d.width / 2, d.y - d.height / 2, d.width, d.height)),
            b.beginPath(),
        ...
        function f(b, c, d, f, g) {
            return function() {
                var h = a(b);
                e(b, c, d, f, g),
                f.layer ? F(h, d, g, "load") : f.load && f.load.call(h[0], g),
                f.layer && (g._masks = d.transforms.masks.slice(0),
                f._next && h.drawLayers({
                    clear: !1,
                    resetFire: !0,
                    index: f._next
                }))
        ...
        var h, i, j, k, l, p, s, t, u, v = this, w = Ea.imageCache;
        for (i = 0; i < v.length; i += 1)
            ...
            t = u.getContext,
            u.src || t ? s = u : u && (w[u] && w[u].complete ? s = w[u] : (s = new ka,
            u.match(/^data:/i) || (s.crossOrigin = l.crossOrigin),
            s.src = u,
            w[u] = s)),
            s && (s.complete || t ? f(h, j, k, l, p)() : (s.onload = f(h, j, k, l, p),
            s.src = s.src))));
        return v
    }
    ,
    a.fn.createPattern = function(b) {
        function d() {
            j = e.createPattern(h, f.repeat),
            f.load && f.load.call(l[0], j)
        }
        ...
        k.call(h, i),
        d()) : (i = k.getContext,
        k.src || i ? h = k : (h = new ka,
        k.match(/^data:/i) || (h.crossOrigin = f.crossOrigin),
        h.src = k),
        h.complete || i ? d() : (h.onload = d,
        h.src = h.src))) : j = null,
        j
    }
    ,
    a.fn.createGradient = function(a) {
        var b, d, e, f, h, i, j, k, l, m, n = this, o = [];
        if (d = new c(a),
        b = g(n[0])) {
            for (d.x1 = d.x1 || 0,
            d.y1 = d.y1 || 0,
    ...
    a.fn.setPixels = function a(b) {
        ...
        for (e = 0; e < o.length; e += 1)
            ...
            f && (i = new c(b),
            G(d, i, b, a),
            q(o[e], f, i, i.width, i.height),
            null !== i.width && null !== i.height || (i.width = d.width,
            i.height = d.height,
            i.x = i.width / 2,
            i.y = i.height / 2),
            0 !== i.width && 0 !== i.height)) {
                if (k = f.getImageData((i.x - i.width / 2) * h.pixelRatio, (i.y - i.height / 2) * h.pixelRatio, i.width * h.pixelRatio, i.height * h.pixelRatio),
                l = k.data,
                n = l.length,
                i.each)
                    for (m = 0; m < n; m += 4)
                        ...
                        l[m + 2] = j.b,
                        l[m + 3] = j.a;
                f.putImageData(k, (i.x - i.width / 2) * h.pixelRatio, (i.y - i.height / 2) * h.pixelRatio),
                f.restore()
            }
        return o
    }
